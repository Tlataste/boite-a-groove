                ...
                <div className="song-cover">
                  <div className="cadre">
                      <div className="image-wrapper">
                        <svg xmlns="http://www.w3.org/2000/svg" width="105" height="113" viewBox="0 0 105 113" fill="none">
                          ...
                          <defs>
                            <filter id="filter0_d_3213_12549" x="-13.625" y="-7.5" width="132" height="132" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="121" height="120" viewBox="0 0 121 120" fill="none">
                    <rect x="0.625" width="120" height="120" rx="60" fill="black"/>
                      <path d="M0.625 60C0.625 26.8629 27.4879 0 60.625 0C93.7621 0 120.625 26.8629 120.625 60C120.625 93.1371 93.7621 120 60.625 120C27.4879 120 0.625 93.1371 0.625 60Z" fill="url(#paint0_radial_3213_12555)" fill-opacity="0.2"/>
